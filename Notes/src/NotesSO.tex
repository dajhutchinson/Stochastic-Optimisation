...
\begin{proposition}{Number of times wrong arm is played}
  ...
  Where $\theta_2(t)$ is the value sampled from the prior of arm 2 at time $t$.
\end{proposition}
...
\begin{proof}{Proposition 1.9}
  ...
  \[ \prob\left(\frac{S_2(t)}{N_2(t)}>\mu_2+\frac\Delta4\big\right)\leq\exp\left(-3\ln(T))=\frac1{T^3}\quad(2) \]
  ...
  \[ \prob\left(\theta_2(t)\geq\mu_2+\frac\Delta2)=\prob\left(\text{Bin}\left(N_2(t)+1,\mu_2+\frac\Delta2)\leq S_2(t)) \]
  ...
  \[ \prob(\theta_2(t)\geq\mu_2+\frac\Delta2)\leq2\frac1{T^3} \]
  \hfill\proved
\end{proof}
